...
gulp.task('browserify', () => {
  buildScript('kentekenplaat.js', [`${config.directories.src}/js/kentekenplaat.js`], 'Kentekenplaat');
  buildScript('kentekenplaat-jquery.js', [`${config.directories.src}/js/kentekenplaat-jquery.js`]);
});
